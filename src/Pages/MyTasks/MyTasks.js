                        ...
                        : <div className='w-full'>
                            ...
                            <div className="flex justify-center text-center w-full">
                                <Link to="/addTask" className="mx-auto w-full">
                                    <button type="button"
                                        className="mx-auto text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2 text-center mr-2 mb-2">Add Task</button>
                                </Link>
                            </div>
                        </div>
                }
