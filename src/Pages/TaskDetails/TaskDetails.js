    ...
    return (
        <div className='mt-20 lg:h-screen p-2'>
            ...
            <div class="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row first-letter:hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 lg:w-4/5 mx-auto">
                <img
                    class="m-2 object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none lg:rounded-lg" src="https://media.istockphoto.com/id/1220731936/photo/high-angle-view-of-to-do-list-on-notepad-on-orange-background.jpg?s=612x612&w=0&k=20&c=YchB2TsZNujjeWHJKw_kU67ZGR1guJSabgXzYM4VDMs="
                    alt="" />
