...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="bg-slate-300/30 backdrop-blur-lg px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0 ">
